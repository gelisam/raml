...
import Data.Aeson.Ordered ( toJSON, Object, (.=), (.:), (.:?)
                  , ToJSON, toEncoding, toJSON
                  , FromJSON, parseJSON
                  )
import Data.Aeson.Ordered.Types ( Value(..), Parser
                        , Options(..)
                        , SumEncoding(..)
                        , defaultOptions
                        , defaultTaggedObject
                        )
import Data.Aeson.Ordered.Types.Internal (Encoding(..))
...
consToValue _ [] = error $ "Data.Aeson.Ordered.TH.consToValue: "
...
consToEncoding _ [] = error $ "Data.Aeson.Ordered.TH.consToEncoding: "
                      ++ "Not a single constructor given!"
...
consFromJSON _ _ [] = error $ "Data.Aeson.Ordered.TH.consFromJSON: "
                              ++ "Not a single constructor given!"
...
withType name f = do
  ...
  where
    ns :: String
    ns = "Data.Aeson.Ordered.TH.withType: "
