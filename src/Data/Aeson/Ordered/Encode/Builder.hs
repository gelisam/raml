...
-- |
-- Module:      Data.Aeson.Ordered.Encode.Builder
...
import Data.Aeson.Ordered.Internal.Time
import Data.Aeson.Ordered.Types.Internal (Encoding(..), Value(..))
...
import qualified Data.AList as HMS
...
object :: HMS.AList T.Text Value -> Builder
...
day dd = encodeYear yr <>
  ...
  where (yr,m,d)    = toGregorian dd
        ...
        encodeYear y
            ...
            | otherwise =
                error "Data.Aeson.Ordered.Encode.Builder.day:  years BCE not supported"
{-# INLINE day #-}
